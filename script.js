...
//videos
const videoURLs = [
    new URL('./static/Videos/video1.mp4', import.meta.url).toString(),
    new URL('./static/Videos/video2.mp4', import.meta.url).toString(),
    new URL('./static/Videos/video3.mp4', import.meta.url).toString()
];
