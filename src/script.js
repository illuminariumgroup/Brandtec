...
//fiddlers_f
planes[10].position.set(-20.0, 3.0, 0.0);
planes[10].scale.set(0.45, 0.45, 0.0);
planes[11].position.set(-18.0, 4.0, 0.0);
planes[11].scale.set(0.35, 0.35, 0.0);
planes[12].position.set(-23.0, 5.0, 0.0);
planes[12].scale.set(0.55, 0.55, 0.0);
planes[13].position.set(-22.0, 6.0, 0.0);
...
textPlane.scale.set(2.0, 0.2, 0.0);
scene.add(textPlane)
